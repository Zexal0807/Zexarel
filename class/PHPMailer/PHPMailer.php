<?php
/*
	This class is my personal rework of PHPMAILER Class, I didn't create it from zero, I copied PHPMAILER Class and modified 
    its
	Questa classe è molto utile in progetti seri, per questo si trova quì, in progetti scolastici non dovrebbe venir mai usata
*/
...
require __DIR__ . "/PHPMailerException.php";
